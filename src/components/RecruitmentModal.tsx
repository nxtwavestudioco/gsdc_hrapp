...
const RecruitmentModal: React.FC<RecruitmentModalProps> = ({ request, open, onClose, onSave, onDelete }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <form className="modal-card" onClick={e => e.stopPropagation()} onSubmit={handleSubmit} autoComplete="off">
        ...
        <div className="recruitment-header-row">
          ...
          <input type="date" className="recruitment-header-input" name="recruitmentDate" value={form.recruitmentDate || ''} onChange={handleChange} aria-label="Recruitment Date" required />
